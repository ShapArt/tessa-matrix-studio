...
Актуально для **TESSA Matrix Studio v1.9.41**.
...
1. Убедиться, что Studio показывает `v1.9.41` и статус среды соответствует ожидаемому; для обычной полной среды — **`Среда: готова`**.
