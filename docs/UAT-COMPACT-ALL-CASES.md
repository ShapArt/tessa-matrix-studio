...
Актуально для **TESSA Matrix Studio v1.17.1**.
...
1. Убедиться, что Studio показывает `v1.9.42` и статус среды соответствует ожидаемому; для обычной полной среды — **`Среда: готова`**.
