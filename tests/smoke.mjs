...
assert(code.includes('// @version      1.9.1'), 'wrong userscript version');
...
assert(code.includes('https://raw.githubusercontent.com/ShapArt/tessa-matrix-studio/main/tessa-matrix-studio.user.js'), 'update/download URL is wrong');
