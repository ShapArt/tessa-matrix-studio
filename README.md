...
[![Version](https://img.shields.io/badge/version-1.9.46-EF233C?style=flat-square)](https://github.com/ShapArt/tessa-matrix-studio/releases/latest)
...
**v1.9.46 · Автор: Шаповалов Артём**

</div>

В 1.9.46 «Скачать отчёт» находится в «Дополнительно». Исправление блокировки после Apply сохранено: отчёт доступен после завершения операции и после «Проверить результат».
...
2. Подтвердите установку версии **1.9.46** в Tampermonkey.
