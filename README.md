...
[![Version](https://img.shields.io/badge/version-1.9.44-EF233C?style=flat-square)](https://github.com/ShapArt/tessa-matrix-studio/releases/latest)
...
Перед релизом пройдите [смешанный UAT 1.9.44](docs/UAT-v1.9.44-PICKER-AUDIT.md): правильные и ошибочные значения в одном файле, все рабочие поля, новые и пустые строки, защита от формул и проверка результата записи.
...
| Проверить новую сборку и каждый тип ввода | [UAT 1.9.44](docs/UAT-v1.9.44-PICKER-AUDIT.md) |
...
<div align="center">
  ...
  <br><sub>Скриншот предыдущей версии. В 1.9.44 вспомогательные кнопки находятся в «Дополнительно».</sub>
</div>
...
2. Подтвердите установку версии **1.9.44** в Tampermonkey.
