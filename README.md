...
[![Version](https://img.shields.io/badge/version-1.9.45-EF233C?style=flat-square)](https://github.com/ShapArt/tessa-matrix-studio/releases/latest)
...
**v1.9.45 · Автор: Шаповалов Артём**

</div>

В 1.9.45 исправлена блокировка «Скачать отчёт» и «Обновить отображение» после Apply. Отчёт остаётся доступным после «Проверить результат».
...
Перед релизом проверьте [скачивание отчёта в 1.9.45](docs/UAT-v1.9.45-REPORT-DOWNLOAD.md) и [смешанный UAT](docs/UAT-v1.9.44-PICKER-AUDIT.md): правильные и ошибочные значения в одном файле, все рабочие поля, новые и пустые строки, защита от формул и проверка результата записи.
...
| Проверить новую сборку и каждый тип ввода | [UAT 1.9.45](docs/UAT-v1.9.45-REPORT-DOWNLOAD.md) |
...
<div align="center">
  ...
  <br><sub>Скриншот предыдущей версии. «Собрать значения» находится рядом со скачиванием Excel; обновление справочников — в «Дополнительно».</sub>
</div>
...
2. Подтвердите установку версии **1.9.45** в Tampermonkey.
...
| **Скачать отчёт** | сохранить последний Apply/ErrorReport JSON; доступен после завершения операции, в том числе после «Проверить результат» |
