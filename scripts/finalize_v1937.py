...
# userscript version only; behavior fixes already landed under TDD.
...
# README current surfaces + release note.
...
# Runbook: actual post-Apply/report behavior.
...
# Public bug template current version.
